...
@class_case_log
class GetIndexNoteMajor(unittest.TestCase):
    ...
    def testCase01_getIndexNote_major(self):
        """获取首页便签_主流程"""

        step('前置构建1条便签数据')
        self.note_id1 = CreateData.create_notes(self.userid, self.wps_sid, addGroupId=False, num=2)
        # print(note_id)
        startindex = 0
        rows = 2
        headers = {
